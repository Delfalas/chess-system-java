...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {   //método para promover o peão a nova peça
 		if (promoted == null) {
 	...
 	private ChessPiece newPiece(String type, Color color) {     //nova peça promovida
